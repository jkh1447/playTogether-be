package com.jkh1447.MyProject.service.matching.strategy.AI;
...
@AllArgsConstructor
@Component
public class AIStrategy implements MatchStrategy {
  ...
  public String generateQueueKey(MatchingRequest request) {
    ...
    if (AIConstants.GROUP_SIZE_ANY.equals(groupSize))
      groupSize = MatchingConstants.ANY_GROUP_SIZE;
    String gameName = AIConstants.GAME_ID;
    String mode = aiMatchingService.getStandardNameString(request);
    String queueKey =
